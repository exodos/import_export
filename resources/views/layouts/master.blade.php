...
<head>
    ...
    <title>Import Export - @yield('title')</title>
...
{{--                    <i class="fas fa-user fa-lg"></i>--}}
                    <i class="bi bi-person-circle" style="font-size: 1.7em; color: #0c84ff"></i>
                </a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="user-panel mt-3 d-flex">
            ...
            <img src="{{asset('img/logo_try_1.png')}}"  alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
